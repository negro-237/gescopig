...
@section('content')
    ...
    <div class="content">
        <h1>
        {!! isset($enseignements->first()->id) ? $enseignements->first()->specialite->slug. ' ' .$enseignements->first()->ecue->semestre->cycle->niveau .' - '. $enseignements->first()->ecue->semestre->title : $specialite->slug. ' ' .$semestre->cycle->niveau !!} - Yaoundé
        </h1>
