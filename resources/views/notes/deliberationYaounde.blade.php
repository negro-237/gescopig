...
@section('content')
    ...
    <div class="content">
        <h1>
            {!! $specialite->slug. ''. $semestre->cycle->niveau. ' - '. $semestre->title !!} : Deliberation - Yaounde
        </h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="pull-right">
                                        <a href="{{ route('notes.noteDeliberationYaounde', ['session1', $contrat->id, $semestre->id]) }}" class="btn btn-info btn-sm">1ere Session</a>
                                        <a href="{{ route('notes.noteDeliberationYaounde', ['session2',$contrat->id, $semestre->id]) }}" class="btn btn-warning btn-sm">2e Session</a>
                                    </div>
                                </td>
                            </tr>
                        @endif
