...
@section('content')
    ...
    <div class="content">
        <div class="box box-primary">
            <div class="box-body">
                {!! Form::open(['url' => 'notes2/'.$type.'/'.$enseignement->id]) !!}
            ...
            <div class="box-footer text-right m">
                ...
                <a href="{{ route('notes.afficheNotesYaounde', [$enseignement->ecue->semestre_id, $enseignement->specialite_id]) }}" class="btn btn-default">
                    Back
                </a>
            </div>
            {!! Form::close() !!}
