...
@section('content')
    ...
    <div class="content">
        <h1>
            {!! $specialite->slug. ''. $semestre->cycle->niveau. ' - '. $semestre->title !!} : Deliberation - Douala
        </h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="pull-right">
                                        <a href="{{ route('notes.noteDeliberationDouala', ['session1', $contrat->id, $semestre->id]) }}" class="btn btn-info btn-sm">1ere Session</a>
                                        <a href="{{ route('notes.noteDeliberationDouala', ['session2',$contrat->id, $semestre->id]) }}" class="btn btn-warning btn-sm">2e Session</a>
                                    </div>
                                </td>
                            </tr>
                        @endif
