                ...
                <div class="container-fluid">
                    ...
                    <div class="text-justify">
                        <p>
                            ...
                            spécialité <strong>{{ $contrat->specialite->title }}</strong> dans notre établissement pour le compte {!! ($type == 'certificat' || !isset($semestre)) ? '' : ' du '. $semestre !!} de l'année académique <strong>{{ $contrat->academic_year->debut. '-' .$contrat->academic_year->fin }}.</strong>
                        </p>
